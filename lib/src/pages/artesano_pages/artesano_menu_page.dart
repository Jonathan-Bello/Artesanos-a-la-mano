    ...
    if (i == 1) {
      ...
      return Card(
        ...
        child: ListTile(
          ...
          onTap: () =>Navigator.pushNamed(context, 'PerfilTienda',arguments: artesano),
        ),
      );
    }
    return null;
  ...
  Widget _obtenerArtesano(ArtesanoBloc bloc,ProductosBloc productosBloc){
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<ArtesanosModel> snapshot){
        ...
        return Column(
          children: <Widget>[
            FadeInRight(child: _cardArtesano(1,context),duration: Duration(milliseconds: 300),),
            FadeInRight(
  ...
  Widget _crearItem(BuildContext context,Map<String,dynamic> producto){
    ...
    return Container(
      ...
      child: Card(
        child: Column(
          children: <Widget>[
              Text('Tu producto con mas popular',
                style: TextStyle(
                  fontSize: 20,
                  fontStyle: FontStyle.italic
                ),
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(width: 10,),
                            Text('${producto['NoLikes']}',overflow: TextOverflow.clip,),
                          ],
                        ),
                      ],
                    )
              ...
              subtitle: Text( "Descripción: "+producto['Descripcion'], style: TextStyle(
                //fontSize: 10
              ), ),
              dense: true,
