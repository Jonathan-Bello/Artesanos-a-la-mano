...
class ClienteTiendaPage extends StatelessWidget {
  ...
  Widget _artesanoUbicacion(ArtesanosModel artesanosModel, BuildContext context, List<String> municipios){
  ...
  Widget _artesanoContacto(ArtesanosModel artesanosModel, BuildContext context){
    final size= MediaQuery.of(context).size;
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 20.0),
      child: Column(
          ...
          StreamBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot<List<ProductoModel>> snapshot){
              if(snapshot.hasData){
                ...
                return ProductosHorizontal(produtos: productos,ruta: 'ProductoDetallesTienda',);
              }else{
