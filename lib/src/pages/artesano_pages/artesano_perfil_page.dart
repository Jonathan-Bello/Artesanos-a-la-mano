...
class _PerfilArtesanoPageState extends State<PerfilArtesanoPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final ArtesanosModel artesanoData= ModalRoute.of(context).settings.arguments;
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: Column(
                children: <Widget>[
                Container(child: Text("    Municipio:",style: TextStyle(fontSize: 13,color: Colors.black45),),width: _screenSize.width*.8, ),
                  _crearMunicipios(),
                ],
              ),
            ),
    ...
    return Column(
      children: <Widget>[
        ...
        Container(
          ...
          child: Text("Región: "+artesano.region.toString(),style: TextStyle(color: Colors.black87),),
        )
      ],
    );
  }
